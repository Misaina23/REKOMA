  ...
  head: () => ({
    meta: [
      ...
      { title: "REKOMA — Projet de Développement Intégré de Midongy Atsimo" },
      {
        name: "description",
        content:
          "REKOMA porte le PDIMA : sept axes de développement intégré à Midongy Atsimo, Madagascar.",
      },
      { name: "author", content: "Association REKOMA" },
      { property: "og:site_name", content: "REKOMA — PDIMA" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Association communautaire porteuse du Projet de Développement Intégré de Midongy Atsimo (PDIMA).",
          foundingDate: "2025",
          address: {
            "@type": "PostalAddress",
    ...
    <QueryClientProvider client={queryClient}>
      <ThemeProvider>
        <LanguageProvider>
          ...
          {!isAdminRoute ? <VisitorTracker /> : null}
