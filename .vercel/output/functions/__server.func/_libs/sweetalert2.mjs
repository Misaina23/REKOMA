//#region node_modules/sweetalert2/dist/sweetalert2.esm.all.js
/*!
...
*/
var removeKeydownHandler = (globalState) => {
...
*/
var addKeydownHandler = (globalState, innerParams, dismissWith) => {
...
var deprecatedParams = { allowEnterKey: void 0 };
...
* @param {(dismiss: DismissReason) => void} dismissWith
*/
var setupTimer = (globalState, innerParams, dismissWith) => {
	const timerProgressBar = getTimerProgressBar();
